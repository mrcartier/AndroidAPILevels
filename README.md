A ListView that shows Android API levels, codenames and versions. The screenshots below shows the app running on both the iPhoneX simulator & Google Nexus 5X emulator.
